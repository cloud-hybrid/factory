...
export declare function visibility(x: ts.PropertyLikeDeclaration | ts.FunctionLikeDeclarationBase): "public" | "private" | "protected";
export declare function isReadOnly(x: ts.PropertyLikeDeclaration | ts.FunctionLikeDeclarationBase): boolean;
/**
