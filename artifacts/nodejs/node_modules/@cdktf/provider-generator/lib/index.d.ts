...
export { readSchema, ProviderSchema, Schema, BlockType, AttributeType, Block, } from "./get/generator/provider-schema";
import * as srcmak from "jsii-srcmak";
export declare function generateProviderBindingsFromSchema(targetPath: string, schemaJSON: any, options?: srcmak.Options): Promise<void>;
