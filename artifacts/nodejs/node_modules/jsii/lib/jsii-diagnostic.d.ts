...
export declare class Code<T extends DiagnosticMessageFormatter = DiagnosticMessageFormatter> {
     ...
     * @internal
     */
    static message<T extends DiagnosticMessageFormatter>({ code, name, formatter, }: {
        code: number;
        formatter: T;
        name: string;
    }): Code<T>;
     ...
     * @internal
     */
    static suggestion<T extends DiagnosticMessageFormatter>({ code, name, formatter, }: {
        code: number;
        formatter: T;
        name: string;
    }): Code<T>;
     ...
     * @internal
     */
    static warning<T extends DiagnosticMessageFormatter>({ code, name, formatter, }: {
        code: number;
        formatter: T;
        name: string;
    }): Code<T>;
     ...
     * @internal
     */
    static error<T extends DiagnosticMessageFormatter>({ code, name, formatter, }: {
        code: number;
        formatter: T;
        name: string;
    }): Code<T>;
     ...
     * @param args     the arguments to the message formatter.
     */
    create(location: ts.Node, ...args: Parameters<T>): JsiiDiagnostic;
}
/**
...
export declare class JsiiDiagnostic implements ts.Diagnostic {
    ...
    static readonly JSII_5010_OVERRIDE_CHANGES_MUTABILITY: Code<(newElement: string, action: string, newMutable?: any, oldMutable?: any) => string>;
    ...
    static readonly JSII_8000_PASCAL_CASED_TYPE_NAMES: Code<(badName: string) => string>;
     ...
     * @internal
     */
    constructor(code: Code, messageText: string | ts.DiagnosticMessageChain, location?: ts.Node);
     ...
     * @returns `this`
     */
    preformat(projectRoot: string): this;
}
export declare type DiagnosticMessageFormatter = (...args: any[]) => JsiiDiagnostic['messageText'];
