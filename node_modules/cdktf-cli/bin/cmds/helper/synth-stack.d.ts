...
declare type SynthOrigin = "watch";
export declare class SynthStack {
    static synth(command: string, outdir: string, graceful?: boolean, // will not exit the process but rethrow the error instead
    synthOrigin?: SynthOrigin): Promise<SynthesizedStack[]>;
