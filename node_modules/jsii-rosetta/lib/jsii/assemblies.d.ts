 ...
 */
export declare function loadAssemblies(assemblyLocations: readonly string[], validateAssemblies: boolean): Promise<readonly LoadedAssembly[]>;
/**
...
export declare function allTypeScriptSnippets(assemblies: readonly LoadedAssembly[], loose?: boolean): TypeScriptSnippet[];
/**
 ...
 */
export declare function replaceAssembly(assembly: spec.Assembly, directory: string): Promise<void>;
